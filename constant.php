...
// configure HIHAT in this file
    ...
    define('MYSQL_USER', 'honeyUser');                       // username for sql-database
    define('MYSQL_PASS', 'honeyPass');                       // passowrd for sql-database    
    ...
    define('GOOGLE_MAPS_KEY', 'key for google maps');  // key for google-maps, has to match URL of website 
